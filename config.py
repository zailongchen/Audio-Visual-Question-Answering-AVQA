...
parser.add_argument("--posi_video_dir",type=str,default='/data/avst/r2plus1d_18/',help="posi_video dir",)
parser.add_argument("--nega_video_dir",type=str,default='/data/avst/r2plus1d_18/',help="nega_video dir",)
...
parser.add_argument("--checkpoint",type=str,default='checkpoint_0.1gl',help="folder name of saved model",)
