...
class AVQA_Fusion_Net(nn.Module):
    def __init__(self, args):
        ...
        # get the feature from [-2] layer of r2plus1d_18
...
#         video_nega = rearrange(video_nega, '(b t) c k h w -> b t (c k h w)', t=T)
        ...
        # zombie_question_memory = torch.ones(B, 14, 512).to(self.device)
        ...
        # fusion module of the global and local features
